...
$conf['settings']['default.timezone'] = '#TIMEZONE#';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = '#ADMIN_MAIL#';         // email address of admin user
...
$conf['settings']['script.url'] = '#SCRIPT_URL#';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = '#DB_BOOKED_USER#';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '#DB_BOOKED_PASSWORD#';
$conf['settings']['database']['hostspec'] = '#DB_HOST#';        // ip, dns or named pipe
$conf['settings']['database']['name'] = '#DB_NAME#';
/**
 * Mail server configuration
 */
$conf['settings']['phpmailer']['mailer'] = '#MAILER#';              // options are 'mail', 'smtp' or 'sendmail'
$conf['settings']['phpmailer']['smtp.host'] = '#SMTP_HOST#';               // 'smtp.company.com'
$conf['settings']['phpmailer']['smtp.port'] = '#SMTP_PORT#';
$conf['settings']['phpmailer']['smtp.secure'] = '#SMTP_SECURE#';             // options are '', 'ssl' or 'tls'
$conf['settings']['phpmailer']['smtp.auth'] = '#SMTP_AUTH#';           // options are 'true' or 'false'
$conf['settings']['phpmailer']['smtp.username'] = '#SMTP_USERNAME#';
$conf['settings']['phpmailer']['smtp.password'] = '#SMTP_PASSWORD#';
